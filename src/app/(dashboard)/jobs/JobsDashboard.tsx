...
export function JobsDashboard({
      ...
      >
        ...
        <div className="flex items-start justify-between gap-2 mb-4 relative z-10">
          <div className="flex flex-wrap gap-1.5 items-center">
            ...
            <span className={`px-2.5 py-0.5 rounded-full text-[11px] font-bold tracking-wide border flex items-center gap-1 ${isRemote
          ...
          <button
            type="button"
            className={`h-8 w-8 rounded-full transition-all duration-200 p-0 hover:scale-110 active:scale-95 flex items-center justify-center shrink-0 shadow-2xs ${isLiked ? "text-rose-500 bg-rose-50 border border-rose-200" : "text-slate-300 hover:text-rose-500 hover:bg-rose-50"
              }`}
  ...
  return (
    <>
      ...
      {/* Tabs Bar - 3-Column Segmented Control on Mobile, Flex on Desktop */}
      <div className="grid grid-cols-3 sm:flex sm:items-center gap-1 sm:gap-1.5 p-1 sm:p-1.5 bg-slate-100 rounded-2xl w-full sm:w-fit mb-6">
        <button
          ...
          className={`flex items-center justify-center gap-1.5 sm:gap-2 px-2 sm:px-5 py-2.5 rounded-xl text-xs sm:text-sm font-bold transition-all ${activeTab === "jobs"
              ? "bg-white text-slate-900 shadow-sm ring-1 ring-slate-900/5"
              : "text-slate-500 hover:text-slate-800 hover:bg-white/50"
            }`}
        >
          <Briefcase className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-violet-600 shrink-0" />
          <span className="sm:hidden">Jobs</span>
          <span className="hidden sm:inline">Recommended Jobs</span>
        </button>

        <button
          onClick={() => setActiveTab("wishlist")}
          className={`flex items-center justify-center gap-1.5 sm:gap-2 px-2 sm:px-5 py-2.5 rounded-xl text-xs sm:text-sm font-bold transition-all ${activeTab === "wishlist"
              ? "bg-white text-rose-600 shadow-sm ring-1 ring-rose-500/10"
              : "text-slate-500 hover:text-slate-800 hover:bg-white/50"
            }`}
        >
          <Heart
            className={`w-3.5 h-3.5 sm:w-4 sm:h-4 shrink-0 ${activeTab === "wishlist" || wishlistJobs.length > 0
          ...
          {wishlistJobs.length > 0 && (
            <span
              className={`px-1 sm:px-1.5 py-0.5 rounded-full text-[9px] sm:text-[10px] font-extrabold min-w-[16px] text-center leading-none ${activeTab === "wishlist"
        ...
        <button
          ...
          className={`flex items-center justify-center gap-1.5 sm:gap-2 px-2 sm:px-5 py-2.5 rounded-xl text-xs sm:text-sm font-bold transition-all ${activeTab === "articles"
              ? "bg-white text-slate-900 shadow-sm ring-1 ring-slate-900/5"
              : "text-slate-500 hover:text-slate-800 hover:bg-white/50"
            }`}
        >
          ...
          <span className="hidden sm:inline">Career Resources</span>
        </button>
      </div>
